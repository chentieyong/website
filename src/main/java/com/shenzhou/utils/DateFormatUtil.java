...
//			System.out.println(DateFormatUtil.formatDate(simpleDateFormat.parse("Mon Mar 03 2014 00:00:00 +0800"), "yyyy-MM-dd"));

//		Date now = new Date();
//		SimpleDateFormat sdf = new SimpleDateFormat(DATE_TIME_FORMAT);		
//		long Time=(now.getTime()/1000)+(60*30);
//		now.setTime(Time*1000);
//		String str=sdf.format(now);
//		System.out.println(str);
//		
//		String hh = getDateByDiff(365);
//		String hh = getDateByDiff(30);
//		System.out.println(hh);		
        //System.out.println(String.format("%s", 1));
        //System.out.println(String.format("%s日",1));
        //} catch (ParseException e) {
        //	e.printStackTrace();
        //}

//		long m= getQuot("2015-01-01","2015-03-23");
//		System.out.println(m);
        //System.out.println(getCurrFormatDateTime());

        Calendar calendar = Calendar.getInstance();
        //calendar.add(Calendar.DATE, -diff);
//		Date date = parseStringToDate("2014-12-12");
        Date date = calendar.getTime();
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        //return df.format(date);
